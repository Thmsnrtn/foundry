...
program
  ...
  .action(async () => {
    ...
    const migrations = ['001_initial.sql', '002_wisdom_remediation.sql', '003_ux_intelligence.sql', '004_signal_wisdom.sql', '005_signal_history.sql', '006_intelligence_layer.sql'];
