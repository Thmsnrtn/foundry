...
const FOUNDER_SCOPED: Record<string, { reason: string; onAccountErasure: AccountErasure }> = {
  ...
  search_briefs: {
    reason: 'what one person\'s search was looking for, and the words it tried',
    onAccountErasure: { op: 'delete' },
  },
  opportunity_seeds: {
...
const NOT_COMPANY_DATA: Record<string, string> = {
  ...
  substrate_evaluations: 'what was read about each kind of computer the institution could use, with the source it was read from; a record about vendors, naming no person',
