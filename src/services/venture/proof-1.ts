...
export const PROOF1_PUBLIC = {
  ...
  // and the answer is measurable rather than rhetorical. Every number in it was
  // counted against this edition. It does not say COMMBUYS is bad; it says a
  // bid is filed the way the agency thinks of the job.
  what: 'One brief, by email, within a business day of paying. It\'s a fixed edition rather than a live feed: this one was pulled from COMMBUYS on 10 September 2026. Twenty-three notices, out of the 726 that were open for bidding that day with an opening date still ahead. Each one gives you the bid number, when it opens, who to contact, a line on why it might fit, and a link to the notice so you can read it yourself.\n\nYou can search COMMBUYS yourself for free, and if you bid public work you are probably on it already. The difficulty is that a bid is filed the way the agency thinks of the job. In this edition, searching the notice titles for cabinet, millwork, casework, countertop or carpentry finds two of the twenty-three; searching the item text for the same words finds three; and fourteen are filed under general building construction, the same code as every other renovation in the state. The rest only show themselves when you open the notice and read the scope — "kitchen, pantry, and bathroom replacement", "new kitchen cabinets & solid surface countertops", "replacement of residential building wood doors in existing frames". That reading is what you are paying for.',
