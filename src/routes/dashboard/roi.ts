      ...
      <div class="card">
        ...
        <div style="display:flex;flex-direction:column;gap:0.75rem;">
          ${breakdown.top_recommendations.map((rec) => html`
            <div style="display:flex;justify-content:space-between;align-items:flex-start;padding:0.75rem;background:var(--bg-secondary,#f8fafc);border-radius:0.5rem;gap:1rem;">
