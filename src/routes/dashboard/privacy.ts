      ...
      <div style="padding:1.25rem;display:flex;flex-direction:column;gap:1.25rem;">
        ...
        <div style="display:flex;align-items:flex-start;gap:1rem;flex-wrap:wrap;">
          <div style="flex:1;min-width:200px;">
            <div style="font-size:0.875rem;font-weight:600;color:var(--text-primary);margin-bottom:0.25rem;">Export All Data</div>
            <p style="margin:0;font-size:0.8rem;color:var(--text-dim);line-height:1.5;">Download a complete copy of your product data in JSON format — metrics, briefings, decisions, customers, and agent configuration.</p>
          </div>
          <a href="/privacy/export" class="btn btn-ghost" style="white-space:nowrap;flex-shrink:0;">Download JSON</a>
        </div>
        ...
        <div style="border-top:1px solid rgba(255,255,255,0.05);padding-top:1.25rem;display:flex;align-items:flex-start;gap:1rem;flex-wrap:wrap;">
          <div style="flex:1;min-width:200px;">
            <div style="font-size:0.875rem;font-weight:600;color:#ff6b6b;margin-bottom:0.25rem;">Request Account Deletion</div>
            <p style="margin:0;font-size:0.8rem;color:var(--text-dim);line-height:1.5;">Permanently delete your product and all associated data. This action cannot be undone. Please export your data first.</p>
          </div>
          <button
            type="button"
            class="btn"
...
privacySettings.get('/privacy/export', async (c) => {
  ...
  const data = await exportProductData(ctx.productId, 'json');
